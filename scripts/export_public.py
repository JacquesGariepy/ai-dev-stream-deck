...
PATTERNS=['agentdeck/*.ps1','agentdeck/*.json','aidev/**/*.py','aidev/scripts/*.ps1','scripts/*.py','scripts/*.ps1','tests/*.py','docs/*.md','docs/images/*.png','docs/images/*.jpg','.github/workflows/*.yml']
