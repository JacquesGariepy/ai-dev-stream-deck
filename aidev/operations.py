...
class Operations:
    ...
    def refresh_activity(self):
        ...
        self.receipt_rows = {row['id']:row for row in receipts()}
    ...
    def receipt_detail(self):
        ...
        self.follow_button.configure(state='normal' if terminal else 'disabled')
    ...
    def follow_receipt(self):
        ...
        objective += '\nOriginal objective: ' + row.get('objective', '')
